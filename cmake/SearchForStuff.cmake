...
set(tbb_library /usr/local/lib/libtbb.dylib)
    if (tbb_library)
      set(TBB_FOUND true)
...
find_path(QWT_INCLUDE_DIR NAMES qwt.h PATHS
  ...
  /usr/local/libexec/qt5/lib/qwt.framework/Headers
  /opt/local/libexec/qt5/lib/qwt-qt5.framework/Headers
  ${QWT_WIN_INCLUDE_DIR}
)

set(QWT_LIBRARY "/usr/local/libexec/qt5/lib/qwt.framework/qwt-qt5")
# version
...
message (STATUS "Looking for qwt - found: version ${QWT_INCLUDE_DIR}")
message (STATUS "Looking for qwt - found: version ${QWT_LIBRARY}")
